...
export function ProductCard({ onAddToCart, product }: ProductCardProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg bg-white text-left shadow-[0_10px_28px_rgba(94,54,30,0.12)] transition hover:-translate-y-0.5 hover:shadow-[0_14px_32px_rgba(94,54,30,0.16)]">
      {/* Invisible full-card trigger below the "+" button (z-10 vs z-20), so
          tapping anywhere opens the details and the "+" adds straight to the
          cart — without nesting interactive elements. */}
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-7 flex items-center justify-between">
          ...
          <button
            ...
            className="relative z-20 grid h-10 w-10 place-items-center rounded-lg bg-primary-card text-white shadow-sm transition hover:bg-primary-hover"
            onClick={() =>
              onAddToCart(product, { instructions: "", quantity: 1 })
            }
            type="button"
          >
